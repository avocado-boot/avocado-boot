 ...
 */
@Component
public class GrantCodeGrantService implements IGrantCodeService {

    /**
     * 缓存名称
     */
    private final static String SECURITY_ACCESS_CODE = "security:access:code:%s";
    ...
    public GrantCode selectByCode(String code) {
        String cacheKey = String.format(SECURITY_ACCESS_CODE,code);
        //  获取授权码
        GrantCode grantCode = (GrantCode)RedisUtil.get(cacheKey);
